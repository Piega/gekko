...
var exchanges = [
  ...
  },
  {
    ...
    direct: false,
    infinityOrder: false,
    currencies: ['CAD', 'EUR', 'ETH', 'GBP', 'JPY', 'LTC', 'USD', 'XBT', 'XDG', 'XLM', 'XRP'],
    assets: ['XBT', 'DAO', 'ETH', 'LTC', 'XDG', 'XLM', 'XRP'],
    markets: [
      ...
      { pair: ['XBT', 'XLM'], minimalOrder: { amount: 0.01, unit: 'currency' } },
      { pair: ['XBT', 'XRP'], minimalOrder: { amount: 0.01, unit: 'currency' } },
    ],
    requires: ['key', 'secret'],
    providesHistory: false,
    tid: 'date'
